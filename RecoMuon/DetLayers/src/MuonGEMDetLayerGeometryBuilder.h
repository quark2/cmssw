...
class MuonGEMDetLayerGeometryBuilder {
 ...
 private:
  static MuRingForwardLayer* buildLayer(int endcap,std::vector<int>& rings, int station,int layer,std::vector<int>& chambers,std::vector<int>& rolls,const GEMGeometry& geo);          
