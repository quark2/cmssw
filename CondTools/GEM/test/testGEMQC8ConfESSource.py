...
process.GEMQC8ConfESSource.DebugMode = cms.untracked.int32(1)
process.GEMQC8ConfESSource.WriteDummy = cms.untracked.int32(0) # -1 -- P5 data
process.GEMQC8ConfESSource.NoDBOutput = cms.untracked.int32(1) # no PoolDBOutputService?
process.GEMQC8ConfESSource.OnlyConfDef = cms.untracked.int32(0)
process.GEMQC8ConfESSource.printValues = cms.untracked.bool( True )
