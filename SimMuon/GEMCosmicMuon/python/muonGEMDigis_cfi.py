...
gemDigiCommonParameters = cms.PSet(
    ...
    simulateIntrinsicNoise = cms.bool(True),
    simulateElectronBkg = cms.bool(False),	#True=simulate electron Bkg
    simulateNeutralBkg = cms.bool(False),	#Ture=simulate neutral Bkg
